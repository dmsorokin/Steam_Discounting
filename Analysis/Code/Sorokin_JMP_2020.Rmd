---
 ...
 abstract: |
  \onehalfspacing \noindent 
  I document that firms in online marketplaces use price promotions 
  ...
  not previously studied. \thispagestyle{empty}
...
When would the firm be willing to give a discount? Consider a firm with $s > 1/2$. Such a firm could be regarded as one that is close to a review upgrade. The expected value to the firm of giving a discount is 
