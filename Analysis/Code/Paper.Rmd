...
\noindent for $y_{it}$ being the number of new reviews for game $i$ on day $t$ and game $i$'s 
...
reg2 <- plm(score~ discNew + discNewLag + discNewLag2 + discNewLag3 + discNewLag4 +
                           discNewLag5 + discNewLag6 + discNewLag7 +
                           negative + mPositive + realPositive + vPositive + ovPositive +
...
star.out <- stargazer(reg1, reg2, 
             ...
             se=list(se1),
             dep.var.labels = c("New Reviews", "Score (0-100)"),
