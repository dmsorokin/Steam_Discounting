...
It is instructive to look at the results through the lens of stylized model introduced earlier in the section. Take the products close to a review upgrade first. For such products to choose not to discount the product, the downside risk should be high, or they must have enough reviews to make changing their review score infeasible. Table \ref{potentialTransitionsResults} finds that games with more reviews are indeed less likely to discount, consistent with the idea that discounts are used more often when they can have an effect. As for the size of the downsize risk, it seems intuitive that the risk of review deterioration for a product that is close to upgrading its review label should not be too large. The predictions for games that are close to a review downgrade were more blurred. My findings suggest that reviews left on a discount are not significantly more positive than regular reviews---if it was the case, why would firms choose to stay put and not give a discount? 

The results I presented in this section, therefore, lead to the following hypothesis: reviews left on a discount are not more positive than the ones left off a discount. This hypothesis has found some support in the prior literature, albeit in a different market. @ByersEtAl12 and @Li16 report that customers who choose to go to a restaurant because of a price promotion tend to leave worse reviews, even though the effect could be positive in certain cases [@Li16; @ZhuEtAl19]. Theoretically, this effect is ambiguous. Consumers who buy when the price is low could be a worse match for the product and, thus, leave worse reviews. At the same time, such customers get a higher utility from paying less, which, together with a desire to reciprocate, can lead them to leave better reviews [@CabralLi15; @IfrachEtAl19; @AcemogluEtAl19]. I now turn my attention to investigating this hypothesis, as doing so would be helpful in assessing the results obtained in this section, and would contribute to the literature by providing evidence from a new market.
